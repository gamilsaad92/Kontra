...
export function THead({children}:{children:React.ReactNode}){return <div className="grid grid-cols-12 gap-3 px-4 py-2 text-xs uppercase tracking-wide border-b opacity-70">{children}</div>}
